...
def process_log_data(spark, input_data, output_data):
    ...
    user_table = df.select("userId","firstName","lastName","gender","level").drop_duplicates()
    
    # write users table to parquet files
    user_table.write.parquet(os.path.join(output_data, "users/") , mode="overwrite")
